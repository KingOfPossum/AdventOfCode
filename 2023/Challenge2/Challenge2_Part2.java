	...
	public static void main(String[] args)
	{
		...
		try 
		{
			...
			{			
				...
				List<Integer> greenNums = new ArrayList<Integer>();
				...
				int maxRedAmmount = Collections.max(redNums).intValue();
				int maxGreenAmmount = Collections.max(greenNums).intValue();
				int maxBlueAmmount = Collections.max(blueNums).intValue();					
				
				System.out.println("Max Red : " + maxRedAmmount);
				System.out.println("Max Green : " + maxGreenAmmount);
				System.out.println("Max Blue : " + maxBlueAmmount);
				
				colorSum += maxRedAmmount * maxGreenAmmount * maxBlueAmmount;
